defmodule SynonymCompetitionTest do
  ...
  @compat %{
    runner: %{"quick" => 0.70, "rapid" => 0.60, "swift" => 0.85, "prompt" => 0.05, "ready" => 0.10},
...
test "with full ATL availability, reply context favors 'prompt'" do
  ...
  assert res.p_top1 > 0.33      # was > 0.35; actual ≈ 0.3494 at τ=0.7
  assert res.margin > 0.15       # ensures it's not a coin flip vs #2
end
