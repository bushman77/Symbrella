  ...
  test "winners stabilize in Top-K; losers drift with decay + inhibitions" do
    ...
    cands = [
      ...
      %{
        token_index: 0,
        id: "a0",
        features: %{lex_fit: 0.95, rel_prior: 0.60, activation: 0.20, intent_bias: 0.0}
      },
      %{
        token_index: 0,
        id: "b0",
        features: %{lex_fit: 0.80, rel_prior: 0.60, activation: 0.20, intent_bias: 0.0}
      },
      %{
        token_index: 0,
        id: "c0",
        features: %{lex_fit: 0.70, rel_prior: 0.60, activation: 0.20, intent_bias: 0.0}
      },
      # token 1 — very close top vs runner (will trigger inhibitions)
      %{
        token_index: 1,
        id: "a1",
        features: %{lex_fit: 0.86, rel_prior: 0.55, activation: 0.20, intent_bias: 0.0}
      },
      %{
        token_index: 1,
        id: "b1",
        features: %{lex_fit: 0.84, rel_prior: 0.55, activation: 0.20, intent_bias: 0.0}
      },
      %{
        token_index: 1,
        id: "c1",
        features: %{lex_fit: 0.60, rel_prior: 0.55, activation: 0.20, intent_bias: 0.0}
      }
    ]
