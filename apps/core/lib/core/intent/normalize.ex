defmodule Core.Intent.Normalize do
  ...
  @alias_map %{
    ...
    "definition" => :define,
    "code" => :code,
    "brain_introspect" => :brain_introspect,
    "brain introspect" => :brain_introspect,
    "translate" => :translate,
    ...
    "environmental observation" => :environment_observation,
    "medication issue" => :health_support,
    "sleep distress" => :health_support,
