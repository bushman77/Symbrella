      ...
      >
        ...
        >
          <div class="mx-auto max-w-4xl w-full px-3 sm:px-4 pt-2 pb-3">
            <form id="chat-form" phx-submit="send" class="flex items-end gap-2">
              <textarea
                id="chat-input"
                name="message"
                phx-hook="ChatInput"
              ...
              <%= if @bot_typing do %>
                <button id="chat-stop" type="button" phx-click="stop" class="btn px-4 py-3 rounded-2xl shadow">
                  Stop
                </button>
              <% else %>
                <button id="chat-send" type="submit" class="btn px-4 py-3 rounded-2xl shadow">Send</button>
              <% end %>
            </form>
          </div>
        </footer>
