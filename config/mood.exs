...
config :brain, Brain.MoodCore,
  ...
  baseline: %{
    da:   0.40,   # a bit more reward / exploration
    "5ht": 0.60,  # more serotonin = calmer default
    glu:  0.40,
    ne:   0.40    # slightly *less* default vigilance
  },
...
config :brain, :mood_tone,
  ...
  warm: %{
    ...
    vigilance_max:   0.85,
    inhibition_min:  0.55  # NEW: only warm if serotonin isn't sagging
  },
  cool: %{
    inhibition_min:  0.70
  },
